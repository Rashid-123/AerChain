...
const TaskRow = ({ task, onEdit, onDelete }: Props) => {
    ...
    return (
        <tr className="border-b border-slate-200 hover:bg-bg2 transition-colors">
            <td className="py-3 px-4">
                <span className="text-text1 font-medium text-sm">
                    {task.title ? truncateText(task.title, 40) : "-"}
                </span>
            </td>
            ...
            <td className="py-3 px-4">
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium capitalize ${priorityColors.bg} ${priorityColors.text} border ${priorityColors.border}`}>
                    {task.priority}
                </span>
            </td>
            ...
            <td className="py-3 px-4">
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium capitalize ${statusColors.bg} ${statusColors.text} border ${statusColors.border}`}>
                    {task.status}
                </span>
            </td>
