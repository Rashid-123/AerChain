    ...
    return (
        <Modal open={open} onClose={onClose}>
            ...
            <div className="relative mb-6">
                {(recording || loading) && (
                    <div className="absolute inset-0 bg-black bg-opacity-60 flex justify-center items-center text-white text-xl z-10 rounded-lg">
            ...
            <div className="flex gap-3">
                <button
                    ...
                    className="flex-1 px-4 py-2.5 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    Add Task
                </button>
                <button
                    onClick={onClose}
                    className="flex-1 px-4 py-2.5 text-text2 rounded-lg hover:bg-bg2 transition-colors border border-border1 font-medium"
                >
                    Cancel
                </button>
                <VoiceRecorder
